  ...
  return (
    <section id="hero" className="pt-10">
      <div className="container">
        <div className="w-full px-4 sm:px-8 lg:px-16 leading-none tracking-tighter mb-6">
          <h1
            id="title"
        ...
        <div className="w-11/12 md:w-2/3 px-4 sm:px-8 lg:px-16">
          <p className="text-xl lg:text-4xl font-medium leading-none mb-10 animate-fade animate-once">
      ...
      <div className="flex w-full justify-between px-4 sm:px-8 lg:px-16 mt-24 mb-6">
        ...
        <div className="relative overflow-hidden bg-cover bg-no-repeat">
          {portfolioSelected.map((selected) => (
            <a
              ...
              rel="noreferrer"
            >
              <div className="h-min overflow-hidden rounded-2xl">
                <img
                  src={require("../assets/img/portfolio/" + selected.img)}
                  alt={selected.name}
                  className="rounded-2xl max-w-full transition duration-300 ease-in-out hover:scale-105"
                />
              </div>
